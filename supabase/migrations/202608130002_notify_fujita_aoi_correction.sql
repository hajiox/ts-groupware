...
佐藤 葵さん2名の人事情報の誤紐付けを修正しました。

・フロアの佐藤 葵さん：女性／5日正社員／入社日2025年12月11日
・製造の佐藤 葵さん：男性／パート／入社日2024年12月17日

人事情報だけでなく、有給・過去給与データ・今後の労務データ取込設定まで修正し、給与照合も全員一致を確認済みです。
対応完了です。$message$;
begin
  select count(*)
  into target_count
